...
def rfidTagGained(e):
    ...
    postToServer(source.getSerialNum(), e.tag)
...
def postToServer(reader, tagId):
    params = urllib.urlencode({'readerId': reader, 'tagId':tagId})
    headers = {"Content-type": "application/x-www-form-urlencoded",
               "Accept": "text/plain"}
    conn = httplib.HTTPConnection("localhost:8000")
    conn.request("POST", "/checkin/", params, headers)
